...
eml_ds_paths = np.sort(
        glob.glob(
                '/home/u/u300676/user_data/mprange/era5_tropics/eml_data/2020/'
                'monthly_means/moisture_space/2020/'
                'era5_3h_30N-S_eml_tropics_atlantic_*_2020-07_moisture_space_mean.nc'
                ))
...
pfull_mean_grouped = eml_ds.pfull_mean.T.load()
z_mean_grouped = eml_ds.z_mean.T.load()
# zhalf_mean_grouped = eml_ds.zhalf_mean.T.load()
...
rh_mean_grouped = eml_ds.rh_mean.T.load()
rh_std_grouped = eml_ds.rh_std.T.load()
w_mean_grouped = eml_ds.w_mean.T.load()
q_mean_grouped = eml_ds.q_mean.T.load()
t_mean_grouped = eml_ds.t_mean.T.load()
...
plt.savefig(
    'plots/era5/era5_moisture_space_rh_mean_psi_p_iwv_2020-07_atlantic.png', 
    dpi=300)